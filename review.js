...
// 5.) Use any of the variables above or create new ones and print using string interpolation
 console.log(`these are variables: ${var_1} and ${var_2}`)
...
// Unicode are numbers that the computer complier convert into and stores for each letter in memory
const fname = 'Teddy';
console.log(fname.charCodeAt(2));

// Using fromCharCode() - make it readable for us :). You'll see!
let fnameChar = String.fromCharCode(100);
console.log(fnameChar);
...
console.log(str2.endsWith("planet!"));
...
let extraLoving = "  Hello World  ";
console.log(extraLoving.trim());
...
for (let i = 0; i < 10; i++) {
    console.log("The room is spinning round " + (i + 1));
}

// Harry said that was so mean of Teo to do Ken dirty like that. Make Teo's vision spin 20 times FOR LOOP.
for (let i = 0; i < 20; i++) {
    console.log("Everything is spinning round " + (i + 1));
}
...
for (let item in whateverQueenBeySaid) {
...
const exoticFruits = ['dragonfruit', 'mangosteen', 'durian'];
...
console.log(numbersToAddUp.reduce((total, number) => total + number, 0));
// ===== SPREAD OPERATOR ===== 
...
let isCoolest = true;
console.log(isCoolest ? 'You got that right!' : "James wants to argue. He says he's the best!");
...
let goodbyeFunc = hello(); // This will print 'Hello'
goodbyeFunc(); // This will print 'Goodbye'
